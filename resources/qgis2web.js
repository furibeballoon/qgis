...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_HojadeclculosinttuloHoja1_1,
      colName: 'Tipo de elemento (organización, persona)',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([-7900225.567083, -4029807.016888, -7716977.155452, -3920921.296973], map.getSize());
